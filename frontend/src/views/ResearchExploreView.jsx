 ...
 *
 * This is a duplicate of ResearchView.jsx for experimentation and testing new features
 * without affecting the production research page.
 *
 * Features:
 ...
 */
export default function ResearchExploreView() {
    ...
    <div className="research-view">
      <div className="research-view__layout">
        ...
        <div className="research-view__main-panel">
          ...
          <InferenceDebugPanel metadata={metadata} />
        </div>
