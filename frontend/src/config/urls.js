 ...
 *   VITE_FRONTEND_URL: Frontend application URL (default: http://localhost:42887)
 *   VITE_FRONTEND_PORT: Frontend dev server port (default: 42887)
...
const BASE_URLS = {
  ...
  frontend: import.meta.env.VITE_FRONTEND_URL || 'http://localhost:42887',
};
