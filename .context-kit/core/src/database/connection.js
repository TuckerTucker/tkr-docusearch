...
import { DatabaseError, ConnectionError, TransactionError, SchemaError } from './types.js';
...
export class DatabaseConnection {
    ...
    async connect() {
        ...
        try {
            ...
            throw new ConnectionError(`Failed to connect to database: ${error instanceof Error ? error.message : 'Unknown error'}`, error instanceof Error ? error : undefined);
        }
    }
    /**
    ...
    async disconnect() {
        ...
        try {
            ...
            throw new ConnectionError(`Failed to disconnect from database: ${error instanceof Error ? error.message : 'Unknown error'}`, error instanceof Error ? error : undefined);
        }
    }
    /**
    ...
    async transaction(callback, options = {}) {
        ...
        try {
            ...
            throw new TransactionError(`Transaction failed: ${error instanceof Error ? error.message : 'Unknown error'}`, error instanceof Error ? error : undefined);
        }
    }
    /**
     ...
     */
    async initializeSchemaProduction() {
        if (!this.db) {
            throw new ConnectionError('Database not connected');
        }
        try {
      ...
      `);
            ...
            throw new SchemaError(`Production schema initialization failed: ${error instanceof Error ? error.message : 'Unknown error'}`, error instanceof Error ? error : undefined);
        }
    }
    /**
     * Get current schema version
     ...
     */
    async applyMigrationDirectly(migration) {
        if (!this.db) {
            throw new ConnectionError('Database not connected');
        }
        try {
      ...
      `).run(migration.version, migration.name);
            ...
            throw new SchemaError(`Migration ${migration.name} failed: ${error instanceof Error ? error.message : 'Unknown error'}`, error instanceof Error ? error : undefined);
        }
    }
    // ============================================================================
    ...
    async getStats() {
        ...
        try {
            const stats = this.statements.healthCheck().get();
            ...
            throw new DatabaseError(`Failed to get database stats: ${error instanceof Error ? error.message : 'Unknown error'}`, 'STATS_ERROR', error instanceof Error ? error : undefined);
        }
    }
    // ============================================================================
    // QUERY METHODS
    ...
    query(sql, params = []) {
        ...
        try {
            ...
            throw new DatabaseError(`Query failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 'QUERY_ERROR', error instanceof Error ? error : undefined);
        }
    }
    /**
    ...
    execute(sql, params = []) {
        ...
        try {
            ...
            throw new DatabaseError(`Execute failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 'EXECUTE_ERROR', error instanceof Error ? error : undefined);
        }
    }
    // ============================================================================
    ...
    async backup(backupPath) {
        ...
        try {
            ...
            throw new DatabaseError(`Backup failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 'BACKUP_ERROR', error instanceof Error ? error : undefined);
        }
    }
    /**
    ...
    async optimize() {
        ...
        try {
            ...
            throw new DatabaseError(`Optimization failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 'OPTIMIZE_ERROR', error instanceof Error ? error : undefined);
        }
    }
    /**
     * Checkpoint WAL file
    ...
    async checkpoint() {
        ...
        try {
            ...
            throw new DatabaseError(`Checkpoint failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 'CHECKPOINT_ERROR', error instanceof Error ? error : undefined);
        }
    }
    // ============================================================================
    // PRIVATE METHODS
    ...
    configurePragmas() {
        ...
        try {
            ...
            throw new DatabaseError(`Failed to configure pragmas: ${error instanceof Error ? error.message : 'Unknown error'}`, 'PRAGMA_ERROR', error instanceof Error ? error : undefined);
        }
    }
}
/**
