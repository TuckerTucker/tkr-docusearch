...
class TestStructureMetadataCompression:
    ...
    def test_compress_and_decompress_structure(self):
        ...
        structure.headings.append(
            HeadingInfo(text="Introduction", level=HeadingLevel.SECTION_HEADER, page_num=1)
        )
    ...
    def test_compression_reduces_size(self):
        ...
        for i in range(50):
            structure.headings.append(
                HeadingInfo(
                    text=f"Section {i}", level=HeadingLevel.SECTION_HEADER, page_num=i // 10 + 1
                )
            )
...
class TestChromaClientEnhancedMetadata:
    ...
    def test_prepare_enhanced_visual_metadata_structure(self):
        ...
        structure = DocumentStructure()
        structure.headings.append(
            HeadingInfo(text="Test", level=HeadingLevel.SECTION_HEADER, page_num=1)
        )
...
class TestProcessorEnhancedMode:
    ...
    def test_processor_accepts_enhanced_config(self):
        ...
        processor = DocumentProcessor(
            embedding_engine=mock_engine, storage_client=mock_storage, enhanced_mode_config=config
        )
    ...
    def test_processor_legacy_mode_default(self):
        ...
        processor = DocumentProcessor(embedding_engine=mock_engine, storage_client=mock_storage)
